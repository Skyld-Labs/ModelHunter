...
echo -n "Number of applications try to test (some error is not check for the moment) : "
cat ../app_ids_tested.txt | wc -l

echo -n "Number of Report :"
find . -name report.md | wc -l

echo -n "Number of application with AI keyword found :"
...
echo -n "Number of application with AI keyword found (without cnn, rnn) :"
...
echo -n "Number of model found (can contais false positive) : "
find . -type f -wholename "*/models/*" -exec echo {} \; | wc -l

echo -n "Number of model encrypted found (can contais false positive) : "
...
echo -n "Number of application which haven't models and keyword tensorflow : "
...
echo -n "Number of application with a TensorFlow models : "
...
echo -n "Number of application contains Tensorflow encrypted models : "
